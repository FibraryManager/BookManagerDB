...
public class UploadGiteeImgBed {
     ...
     * 码云私人令牌
     */
    public static final String ACCESS_TOKEN = "ae3e402445b64d790a1f642716cb86c0";  //这里不展示我自己的了，需要你自己补充

    /**
     * 码云个人空间名
     */
    public static final String OWNER = "library-manager_1";

    /**
     * 上传指定仓库
     */
    public static final String REPO = "my_admin";


    /**
     * 上传时指定存放图片路径
     */
    public static final String PATH = "static/"; //使用到了日期工具类
